...
CREATE UNIQUE NONCLUSTERED INDEX MenuDetails_MenuID_Index ON MenuDetails (MenuID);

-- Orders_OrderID_Index
CREATE UNIQUE NONCLUSTERED INDEX Orders_OrderID_Index ON Orders (OrderID);

-- OrderDetails_OrderID_Index
CREATE UNIQUE NONCLUSTERED INDEX OrderDetails_OrderID_Index ON OrderDetails (OrderID);
